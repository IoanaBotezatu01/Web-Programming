...
namespace Subiect922.Controllers
{
    public class HotelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,HotelName,Date,City,AvailableRooms")] Hotels hotels)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,HotelName,Date,City,AvailableRooms")] Hotels hotels)
        {
            if (id != hotels.Id)
            {
                return NotFound();
