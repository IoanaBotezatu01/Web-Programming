...
using File = UserFiles.Models.File;
...
namespace UserFiles.Controllers
{
    public class FilesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserId,Filename,Filepath,Size")] File @file)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserId,Filename,Filepath,Size")] File @file)
        {
            if (id != @file.Id)
            {
                return NotFound();
