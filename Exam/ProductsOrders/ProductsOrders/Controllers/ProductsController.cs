...
namespace ProductsOrders.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Filter(string String)
        {
            TempData["String"]=String;
            TempData.Keep("String");
            var products = await _context.Product.Where(p => p.Name.StartsWith(String)).ToListAsync();
